...
public:
	...
	bool autoHide;
	bool dropRestOfWord;
	Hyperion::CaseInsensitiveBehaviour ignoreCaseBehaviour;
	int widthLBDefault;
	int heightLBDefault;
	...
	void Start(Window &parent, int ctrlID, Sci::Position position, Point location,
		Sci::Position startLen_, int lineHeight, bool unicodeMode, Hyperion::Technology technology,
