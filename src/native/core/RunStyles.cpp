...
template class Hyperion::Internal::RunStyles<int, int>;
template class Hyperion::Internal::RunStyles<int, char>;
#if (PTRDIFF_MAX != INT_MAX) || defined(__HAIKU__)
template class Hyperion::Internal::RunStyles<ptrdiff_t, int>;
template class Hyperion::Internal::RunStyles<ptrdiff_t, char>;
#endif
