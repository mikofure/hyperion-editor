...
public:
	...
	Hyperion::IMEInteraction imeInteraction;
	Hyperion::Bidirectional bidirectional;

	Hyperion::FoldFlag foldFlags;
	Hyperion::FoldDisplayTextStyle foldDisplayTextStyle;
	...
	Hyperion::ChangeHistoryOption changeHistoryOption = Hyperion::ChangeHistoryOption::Disabled;
	...
	Hyperion::UndoSelectionHistoryOption undoSelectionHistoryOption = UndoSelectionHistoryOption::Disabled;
	...
	void ChangeUndoSelectionHistory(Hyperion::UndoSelectionHistoryOption undoSelectionHistoryOptionNew);
};
