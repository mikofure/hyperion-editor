...
private:
	...
	bool readOnly;
	bool utf8Substance;
	Hyperion::LineEndType utf8LineEnds;
...
public:
	...
	Hyperion::LineEndType GetLineEndTypes() const noexcept { return utf8LineEnds; }
	void SetLineEndTypes(Hyperion::LineEndType utf8LineEnds_);
