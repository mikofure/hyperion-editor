...
bool Hyperion::Internal::DiscardLastCombinedCharacter(std::string_view &text) noexcept {
...
Sci::Position Cxx11RegexFindText(const Document *doc, Sci::Position minPos, Sci::Position maxPos, const char *s,
	...
	try {
		...
		// Example - search in doc/HyperionHistory.html for
		// [[:upper:]]eta[[:space:]]
...
RegexSearchBase *Hyperion::Internal::CreateRegexSearch(CharClassify *charClassTable) {
