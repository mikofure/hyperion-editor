...
#elif defined(Hyperion_QT)
#undef PLAT_QT
#define PLAT_QT 1

#elif defined(Hyperion_QT_QML)
#undef PLAT_QT_QML
...
struct FontParameters {
	const char *faceName;
	XYPOSITION size;
	Hyperion::FontWeight weight;
	bool italic;
	Hyperion::FontQuality extraFontFlag;
	Hyperion::Technology technology;
	Hyperion::CharacterSet characterSet;
	const char *localeName;
	Hyperion::FontStretch stretch;

	constexpr FontParameters(
		const char *faceName_,
		XYPOSITION size_=10,
		Hyperion::FontWeight weight_= Hyperion::FontWeight::Normal,
		bool italic_=false,
		Hyperion::FontQuality extraFontFlag_= Hyperion::FontQuality::QualityDefault,
		Hyperion::Technology technology_= Hyperion::Technology::Default,
		Hyperion::CharacterSet characterSet_= Hyperion::CharacterSet::Ansi,
		const char *localeName_=localeNameDefault,
		Hyperion::FontStretch stretch_=Hyperion::FontStretch::Normal) noexcept :
...
public:
	...
	static std::unique_ptr<Surface> Allocate(Hyperion::Technology technology);
	...
	virtual int SupportsFeature(Hyperion::Supports feature) noexcept=0;
...
// HyperionBase implements IListBoxDelegate to receive ListBoxEvents from a ListBox
...
public:
	...
	virtual void Create(Window &parent, int ctrlID, Point location, int lineHeight_, bool unicodeMode_, Hyperion::Technology technology_)=0;
