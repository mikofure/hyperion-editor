...
#ifndef HYPERIONCALL_HPP
#define HYPERIONCALL_HPP

namespace Hyperion {

enum class Message;	// Declare in case HyperionMessages.h not included

// Declare in case HyperionStructures.h not included
...
struct Failure {
	Hyperion::Status status;
	explicit Failure(Hyperion::Status status_) noexcept : status(status_) {
	}
};
...
public:
	Hyperion::Status statusLastCall;
	HyperionCall() noexcept;
...
//**\(\*\n\)
	...
	bool UndoCollection();
	Hyperion::WhiteSpace ViewWS();
	void SetViewWS(Hyperion::WhiteSpace viewWS);
	Hyperion::TabDrawMode TabDrawMode();
	void SetTabDrawMode(Hyperion::TabDrawMode tabDrawMode);
	...
	Position EndStyled();
	void ConvertEOLs(Hyperion::EndOfLine eolMode);
	Hyperion::EndOfLine EOLMode();
	void SetEOLMode(Hyperion::EndOfLine eolMode);
	...
	void SetIMEInteraction(Hyperion::IMEInteraction imeInteraction);
	void MarkerDefine(int markerNumber, Hyperion::MarkerSymbol markerSymbol);
	...
	void MarkerSetAlpha(int markerNumber, Hyperion::Alpha alpha);
	Hyperion::Layer MarkerGetLayer(int markerNumber);
	void MarkerSetLayer(int markerNumber, Hyperion::Layer layer);
	void SetMarginTypeN(int margin, Hyperion::MarginType marginType);
	Hyperion::MarginType MarginTypeN(int margin);
	...
	void SetMarginCursorN(int margin, Hyperion::CursorShape cursor);
	Hyperion::CursorShape MarginCursorN(int margin);
	...
	Hyperion::CaseVisible StyleGetCase(int style);
	Hyperion::CharacterSet StyleGetCharacterSet(int style);
	bool StyleGetVisible(int style);
	bool StyleGetChangeable(int style);
	bool StyleGetHotSpot(int style);
	void StyleSetCase(int style, Hyperion::CaseVisible caseVisible);
	void StyleSetSizeFractional(int style, int sizeHundredthPoints);
	int StyleGetSizeFractional(int style);
	void StyleSetWeight(int style, Hyperion::FontWeight weight);
	Hyperion::FontWeight StyleGetWeight(int style);
	void StyleSetCharacterSet(int style, Hyperion::CharacterSet characterSet);
	void StyleSetHotSpot(int style, bool hotspot);
	void StyleSetCheckMonospaced(int style, bool checkMonospaced);
	bool StyleGetCheckMonospaced(int style);
	void StyleSetStretch(int style, Hyperion::FontStretch stretch);
	Hyperion::FontStretch StyleGetStretch(int style);
	...
	void SetElementColour(Hyperion::Element element, ColourAlpha colourElement);
	ColourAlpha ElementColour(Hyperion::Element element);
	void ResetElementColour(Hyperion::Element element);
	bool ElementIsSet(Hyperion::Element element);
	bool ElementAllowsTranslucent(Hyperion::Element element);
	ColourAlpha ElementBaseColour(Hyperion::Element element);
	void SetSelFore(bool useSetting, Colour fore);
	void SetSelBack(bool useSetting, Colour back);
	Hyperion::Alpha SelAlpha();
	void SetSelAlpha(Hyperion::Alpha alpha);
	bool SelEOLFilled();
	void SetSelEOLFilled(bool filled);
	Hyperion::Layer SelectionLayer();
	void SetSelectionLayer(Hyperion::Layer layer);
	Hyperion::Layer CaretLineLayer();
	void SetCaretLineLayer(Hyperion::Layer layer);
	...
	void IndicSetStyle(int indicator, Hyperion::IndicatorStyle indicatorStyle);
	Hyperion::IndicatorStyle IndicGetStyle(int indicator);
	...
	void IndicSetHoverStyle(int indicator, Hyperion::IndicatorStyle indicatorStyle);
	Hyperion::IndicatorStyle IndicGetHoverStyle(int indicator);
	void IndicSetHoverFore(int indicator, Colour fore);
	Colour IndicGetHoverFore(int indicator);
	void IndicSetFlags(int indicator, Hyperion::IndicFlag flags);
	Hyperion::IndicFlag IndicGetFlags(int indicator);
	...
	void AutoCSetOptions(Hyperion::AutoCompleteOption options);
	Hyperion::AutoCompleteOption AutoCGetOptions();
	...
	bool HScrollBar();
	void SetIndentationGuides(Hyperion::IndentView indentView);
	Hyperion::IndentView IndentationGuides();
	...
	void SetPrintColourMode(Hyperion::PrintOption mode);
	Hyperion::PrintOption PrintColourMode();
	Position FindText(Hyperion::FindOption searchFlags, void *ft);
	Position FindTextFull(Hyperion::FindOption searchFlags, TextToFindFull *ft);
	Position FormatRange(bool draw, void *fr);
	Position FormatRangeFull(bool draw, RangeToFormatFull *fr);
	void SetChangeHistory(Hyperion::ChangeHistoryOption changeHistory);
	Hyperion::ChangeHistoryOption ChangeHistory();
	void SetUndoSelectionHistory(Hyperion::UndoSelectionHistoryOption undoSelectionHistory);
	Hyperion::UndoSelectionHistoryOption UndoSelectionHistory();
	...
	void SetSearchFlags(Hyperion::FindOption searchFlags);
	...
	void SetFoldLevel(Line line, Hyperion::FoldLevel level);
	Hyperion::FoldLevel FoldLevel(Line line);
	Line LastChild(Line line, Hyperion::FoldLevel level);
	...
	void FoldDisplayTextSetStyle(Hyperion::FoldDisplayTextStyle style);
	Hyperion::FoldDisplayTextStyle FoldDisplayTextGetStyle();
	void SetDefaultFoldDisplayText(const char *text);
	int GetDefaultFoldDisplayText(char *text);
	std::string GetDefaultFoldDisplayText();
	void FoldLine(Line line, Hyperion::FoldAction action);
	void FoldChildren(Line line, Hyperion::FoldAction action);
	void ExpandChildren(Line line, Hyperion::FoldLevel level);
	void FoldAll(Hyperion::FoldAction action);
	void EnsureVisible(Line line);
	void SetAutomaticFold(Hyperion::AutomaticFold automaticFold);
	Hyperion::AutomaticFold AutomaticFold();
	void SetFoldFlags(Hyperion::FoldFlag flags);
	...
	void SetIdleStyling(Hyperion::IdleStyling idleStyling);
	Hyperion::IdleStyling IdleStyling();
	void SetWrapMode(Hyperion::Wrap wrapMode);
	Hyperion::Wrap WrapMode();
	void SetWrapVisualFlags(Hyperion::WrapVisualFlag wrapVisualFlags);
	Hyperion::WrapVisualFlag WrapVisualFlags();
	void SetWrapVisualFlagsLocation(Hyperion::WrapVisualLocation wrapVisualFlagsLocation);
	Hyperion::WrapVisualLocation WrapVisualFlagsLocation();
	void SetWrapStartIndent(int indent);
	int WrapStartIndent();
	void SetWrapIndentMode(Hyperion::WrapIndentMode wrapIndentMode);
	Hyperion::WrapIndentMode WrapIndentMode();
	void SetLayoutCache(Hyperion::LineCache cacheMode);
	Hyperion::LineCache LayoutCache();
	...
	void SetPhasesDraw(Hyperion::PhasesDraw phases);
	void SetFontQuality(Hyperion::FontQuality fontQuality);
	Hyperion::FontQuality FontQuality();
	void SetFirstVisibleLine(Line displayLine);
	void SetMultiPaste(Hyperion::MultiPaste multiPaste);
	Hyperion::MultiPaste MultiPaste();
	...
	void SetAccessibility(Hyperion::Accessibility accessibility);
	Hyperion::Accessibility Accessibility();
	void LineDown();
	void LineDownExtend();
	void LineUp();
	void LineUpExtend();
	...
	void SetModEventMask(Hyperion::ModificationFlags eventMask);
	Position EdgeColumn();
	void SetEdgeColumn(Position column);
	Hyperion::EdgeVisualStyle EdgeMode();
	void SetEdgeMode(Hyperion::EdgeVisualStyle edgeMode);
	Colour EdgeColour();
	...
	void SearchAnchor();
	Position SearchNext(Hyperion::FindOption searchFlags, const char *text);
	Position SearchPrev(Hyperion::FindOption searchFlags, const char *text);
	Line LinesOnScreen();
	void UsePopUp(Hyperion::PopUp popUpMode);
	bool SelectionIsRectangle();
	void SetZoom(int zoomInPoints);
	int Zoom();
	IDocumentEditable *CreateDocument(Position bytes, Hyperion::DocumentOption documentOptions);
	void AddRefDocument(IDocumentEditable *doc);
	void ReleaseDocument(IDocumentEditable *doc);
	Hyperion::DocumentOption DocumentOptions();
	Hyperion::ModificationFlags ModEventMask();
	void SetCommandEvents(bool commandEvents);
	bool CommandEvents();
	void SetFocus(bool focus);
	bool Focus();
	void SetStatus(Hyperion::Status status);
	Hyperion::Status Status();
	void SetMouseDownCaptures(bool captures);
	bool MouseDownCaptures();
	void SetMouseWheelCaptures(bool captures);
	bool MouseWheelCaptures();
	void SetCursor(Hyperion::CursorShape cursorType);
	...
	void SetVisiblePolicy(Hyperion::VisiblePolicy visiblePolicy, int visibleSlop);
	void DelLineLeft();
	void DelLineRight();
	...
	void ChooseCaretX();
	void GrabFocus();
	void SetXCaretPolicy(Hyperion::CaretPolicy caretPolicy, int caretSlop);
	void SetYCaretPolicy(Hyperion::CaretPolicy caretPolicy, int caretSlop);
	void SetPrintWrapMode(Hyperion::Wrap wrapMode);
	Hyperion::Wrap PrintWrapMode();
	...
	void SetSelectionMode(Hyperion::SelectionMode selectionMode);
	void ChangeSelectionMode(Hyperion::SelectionMode selectionMode);
	Hyperion::SelectionMode SelectionMode();
	...
	void AutoCSetCaseInsensitiveBehaviour(Hyperion::CaseInsensitiveBehaviour behaviour);
	Hyperion::CaseInsensitiveBehaviour AutoCGetCaseInsensitiveBehaviour();
	void AutoCSetMulti(Hyperion::MultiAutoComplete multi);
	Hyperion::MultiAutoComplete AutoCGetMulti();
	void AutoCSetOrder(Hyperion::Ordering order);
	Hyperion::Ordering AutoCGetOrder();
	...
	void SetCaretSticky(Hyperion::CaretSticky useCaretStickyBehaviour);
	void ToggleCaretSticky();
	void SetPasteConvertEndings(bool convert);
	bool PasteConvertEndings();
	void ReplaceRectangular(Position length, const char *text);
	void SelectionDuplicate();
	void SetCaretLineBackAlpha(Hyperion::Alpha alpha);
	Hyperion::Alpha CaretLineBackAlpha();
	void SetCaretStyle(Hyperion::CaretStyle caretStyle);
	Hyperion::CaretStyle CaretStyle();
	...
	void IndicSetAlpha(int indicator, Hyperion::Alpha alpha);
	Hyperion::Alpha IndicGetAlpha(int indicator);
	void IndicSetOutlineAlpha(int indicator, Hyperion::Alpha alpha);
	Hyperion::Alpha IndicGetOutlineAlpha(int indicator);
	void SetExtraAscent(int extraAscent);
	int ExtraAscent();
	void SetExtraDescent(int extraDescent);
	int ExtraDescent();
	Hyperion::MarkerSymbol MarkerSymbolDefined(int markerNumber);
	...
	void SetMarginOptions(Hyperion::MarginOption marginOptions);
	...
	void AnnotationSetVisible(Hyperion::AnnotationVisible visible);
	Hyperion::AnnotationVisible AnnotationGetVisible();
	void AnnotationSetStyleOffset(int style);
	int AnnotationGetStyleOffset();
	void ReleaseAllExtendedStyles();
	int AllocateExtendedStyles(int numberStyles);
	void AddUndoAction(int token, Hyperion::UndoFlags flags);
	...
	void SetVirtualSpaceOptions(Hyperion::VirtualSpace virtualSpaceOptions);
	...
	void SetAdditionalSelAlpha(Hyperion::Alpha alpha);
	Hyperion::Alpha AdditionalSelAlpha();
	...
	void ScrollToStart();
	void ScrollToEnd();
	void SetTechnology(Hyperion::Technology technology);
	Hyperion::Technology Technology();
	void *CreateLoader(Position bytes, Hyperion::DocumentOption documentOptions);
	...
	void SetLineEndTypesAllowed(Hyperion::LineEndType lineEndBitSet);
	Hyperion::LineEndType LineEndTypesAllowed();
	Hyperion::LineEndType LineEndTypesActive();
	...
	void SetRepresentationAppearance(const char *encodedCharacter, Hyperion::RepresentationAppearance appearance);
	Hyperion::RepresentationAppearance RepresentationAppearance(const char *encodedCharacter);
	...
	void EOLAnnotationSetVisible(Hyperion::EOLAnnotationVisible visible);
	Hyperion::EOLAnnotationVisible EOLAnnotationGetVisible();
	void EOLAnnotationSetStyleOffset(int style);
	int EOLAnnotationGetStyleOffset();
	bool SupportsFeature(Hyperion::Supports feature);
	Hyperion::LineCharacterIndexType LineCharacterIndex();
	...
	Line LineFromIndexPosition(Position pos, Hyperion::LineCharacterIndexType lineCharacterIndex);
	Position IndexPositionFromLine(Line line, Hyperion::LineCharacterIndexType lineCharacterIndex);
	void StartRecord();
	void StopRecord();
	int Lexer();
	...
	Hyperion::TypeProperty PropertyType(const char *name);
	...
	Hyperion::LineEndType LineEndTypesSupported();
	...
	void SetBidirectional(Hyperion::Bidirectional bidirectional);
