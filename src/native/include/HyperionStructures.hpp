...
/** @file HyperionStructures.h
 ** Structures used to communicate with Hyperion.
...
struct NotifyHeader {
	 ...
	 * but most clients of Hyperion.h do not have this type visible. */
	void *hwndFrom;
	uptr_t idFrom;
	Notification code;
};

enum class Message;	// Declare in case HyperionMessages.h not included
