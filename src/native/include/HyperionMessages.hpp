...
/** @file HyperionMessages.h
 ** Enumerate the messages that can be sent to Hyperion.
 **/
 ...
 * file which contains any comments about the definitions. HyperionAPIFacer.py does the generation. */

#ifndef HYPERIONMESSAGES_HPP
#define HYPERIONMESSAGES_HPP
