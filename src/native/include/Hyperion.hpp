...
HYPERION_API int Hyperion_RegisterClasses(void *hInstance);
HYPERION_API int Hyperion_ReleaseResources(void);
#endif
 ...
 * So older code that treats Hyperion as a RichEdit will work. */
